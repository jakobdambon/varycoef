...
The argument `cal.res` takes logical values and decides whether the residuals of the SVC model should be computed. This takes some extra time, but can be useful since an extration of those residuals is possible using a method or `residuals`. 
